...
function store_subcategory_2_in_local_storage() {
    var subcategory = document.getElementsByClassName("button1")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
...
function store_subcategory_3_in_local_storage() {
    var subcategory = document.getElementsByClassName("button2")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
function store_subcategory_4_in_local_storage() {
    var subcategory = document.getElementsByClassName("button3")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
function store_subcategory_5_in_local_storage() {
    var subcategory = document.getElementsByClassName("button4")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
function store_subcategory_6_in_local_storage() {
    var subcategory = document.getElementsByClassName("button5")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
function store_subcategory_7_in_local_storage() {
    var subcategory = document.getElementsByClassName("button6")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
function store_subcategory_8_in_local_storage() {
    var subcategory = document.getElementsByClassName("button7")[0].innerHTML;
    localStorage.setItem('user_selected_subcategory', subcategory)
}
